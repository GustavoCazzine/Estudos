        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="https://instagram.com" className="text-salon-light-text hover:text-salon-gold transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://facebook.com" className="text-salon-light-text hover:text-salon-gold transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="https://wa.me/123456789" className="text-salon-light-text hover:text-salon-gold transition-colors">
          ...
          {/* Hours */}
          <div className="space-y-4">
            <h3 className="text-lg font-playfair font-medium">Horário de Funcionamento</h3>
            <ul className="space-y-2">
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h3 className="text-lg font-playfair font-medium">Contato</h3>
            <ul className="space-y-2">
              <li className="flex items-start text-salon-light-text">
                <MapPin className="h-4 w-4 mr-2 mt-1" />
                <span>Rua dos Cílios, 123<br />Bairro Sobrancelha Perfeita<br />São Paulo - SP</span>
              </li>
              <li className="flex items-center text-salon-light-text">

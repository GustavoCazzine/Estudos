...
class Calculadora:
    def __init__(self, master):
        ...
        self.entry_value=''
        Entry(width=17, bg='#fff', font=('Arial Bold', 28, 'bold'), textvariable=self.equation).place(x=0,y=0)
    ...
    def solve(self):
        try:
            ...
            self.equation.set("Erro") # Uma forma simples de lidar com erros de cálculo
